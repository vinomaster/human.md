...
| Agent violates a constraint                    | Process gap         | Flag in calibration log, fix in [persona-file] |
| Human skips review under time pressure         | Human               | Noted in team-state.md                    |
| Ambiguous scope, agent assumes wrong           | Shared              | Roadmap or [persona-file] needs updating       |
